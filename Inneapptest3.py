...
class CreateEventWindow(tk.Toplevel):
    ...
    def create_event(self):
        ...
        if not event_name:
            messagebox.showerror("Input Error", "Event name cannot be empty.")
        else:
            messagebox.showinfo("Success", f"Event '{event_name}' created!")
            self.destroy()
...
class JoinEventWindow(tk.Toplevel):
    ...
    def join_event(self):
        ...
        if not selected_event:
            messagebox.showerror("Selection Error", "Please select an event to join.")
        else:
            messagebox.showinfo("Success", f"Joined '{selected_event}'!")
            self.destroy()
